...
<div class="container" id="s_cart">
    <div class="p-5 bg-white rounded shadow mb-5">
        ...
        <li class="nav-item flex-sm-fill">
            <a id="home-tab" data-toggle="tab" href="#trousers" role="tab" aria-controls="home" aria-selected="true" class="nav-link border-0 text-uppercase font-weight-bold active">Trousers</a>
        </li>
        <li class="nav-item flex-sm-fill">
            <a id="profile-tab" data-toggle="tab" href="#shirts" role="tab" aria-controls="profile" aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold">Shirts</a>
        </li>
        <li class="nav-item flex-sm-fill">
            <a id="contact-tab" data-toggle="tab" href="#sneakers" role="tab" aria-controls="contact" aria-selected="false" class="nav-link border-0 text-uppercase font-weight-bold">Sneakers</a>
        </li>
        </ul>
        <div id="myTabContent" class="tab-content">
        <div id="trousers" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade px-4 py-5 show active">
        <div class="row">
        ...
        <div id="shirts" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
        <div class="row">
            <div class="card text-center" style="width: 14rem;">
    ...
    <div id="sneakers" role="tabpanel" aria-labelledby="profile-tab" class="tab-pane fade px-4 py-5">
        <div class="row">
            <div class="card text-center" style="width: 14rem;">
